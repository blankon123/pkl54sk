 ...
 */
public class EntryListingController {
    ...
    public EntryListingController(EntryFormListingTest form, NextButton nextButton, BackminButton backButton, Closebutton closebutton, Savebutton savebutton, JPanel Mainpanel) {
