...
public class Aboutbutton extends JButton{
    ...
    public Aboutbutton(){
        ...
        icon = new ImageIcon(getClass().getResource("/sp/image/about.png"));
        setIcon(icon);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent me) {
                icon = new ImageIcon(getClass().getResource("/sp/image/about-hover.png"));
                setIcon(icon);
            }
            ...
            public void mousePressed(MouseEvent me) {
                icon = new ImageIcon(getClass().getResource("/sp/image/about-clicked.png"));
                setIcon(icon);
                setActive(true);
            }
