...
public class Hal2 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLayeredPane1.add(b3r1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 40, 240, -1));
        ...
        jLayeredPane1.add(b3r2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 30, 30));
        ...
        jLayeredPane1.add(b3r3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, 40, 30));
        ...
        jLayeredPane1.add(b3r4s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 160, 40, 20));

        b3r4s2.setAngka(true);
        b3r4s2.setMaxDigit(99);
        b3r4s2.setMinDigit(1);
        b3r4s2.setPosisi(4);
        jLayeredPane1.add(b3r4s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 180, 40, 20));
        ...
        jLayeredPane1.add(b3r5s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, 40, 20));

        b3r5s2.setAngka(true);
        b3r5s2.setMaxDigit(99);
        b3r5s2.setMinDigit(1);
        b3r5s2.setPosisi(6);
        jLayeredPane1.add(b3r5s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 240, 40, 20));
        ...
        jLayeredPane1.add(b3r6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 30, 30));

        b3r7.setAngka(true);
        b3r7.setMaxDigit(9);
        b3r7.setPosisi(8);
        b3r7.setRequired(true);
        jLayeredPane1.add(b3r7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 420, 30, 30));
        ...
        jLayeredPane1.add(b3r8s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 560, 30, 20));
        ...
        jLayeredPane1.add(b3r8s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 580, 30, 20));
        ...
        jLayeredPane1.add(b3r8s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 600, 30, 20));
        ...
        jLayeredPane1.add(b3r9s1d1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 650, 30, 30));
        ...
        jLayeredPane1.add(b3r9s1d2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 680, 30, 30));
        ...
        jLayeredPane1.add(b3r9s1d3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 710, 30, 30));
        ...
        jLayeredPane1.add(b3r9s1d4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 740, 30, 30));

        b3r9s2.setAngka(true);
        b3r9s2.setMaxDigit(4);
        b3r9s2.setMinDigit(1);
        b3r9s2.setPosisi(16);
        jLayeredPane1.add(b3r9s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 840, 30, 30));

        b3r10.setAngka(true);
        b3r10.setMaxDigit(2);
        b3r10.setMinDigit(1);
        b3r10.setPosisi(17);
        jLayeredPane1.add(b3r10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 930, 30, 30));

        b3r11.setAngka(true);
        b3r11.setHuruf(true);
        b3r11.setLength(2);
        b3r11.setMaxDigit(99);
        b3r11.setPosisi(18);
        b3r11.setRequired(true);
        jLayeredPane1.add(b3r11, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 140, 30, 30));

        b3r12.setAngka(true);
        b3r12.setMaxDigit(6);
        b3r12.setPosisi(19);
        b3r12.setRequired(true);
        jLayeredPane1.add(b3r12, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 330, 30, 30));
        ...
        jLayeredPane1.add(b3r13, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 570, 30, 30));
        ...
        jLayeredPane1.add(b3r14, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 720, 30, 30));
        ...
        jLayeredPane1.add(b3r15, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 810, 30, 30));
        ...
        jLayeredPane1.add(b3r16, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 910, 30, 30));
